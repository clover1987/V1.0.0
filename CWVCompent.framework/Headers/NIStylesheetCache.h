...
- (NIStylesheet *)stylesheetWithPath:(NSString *)path loadFromDisk:(BOOL)loadFromDisk theme:(NSString *)theme;
- (NIStylesheet *)stylesheetWithPath:(NSString *)path;
- (NIStylesheet *)stylesheetWithPath:(NSString *)path theme:(NSString *)theme;
@end
